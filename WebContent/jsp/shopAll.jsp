...
<body>
	...
	<div class="shopping-choose">
		<div class="rows">
			<div>
				<a href="${pageContext.request.contextPath}/salesDescend"><button>销量
						↑</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/NewProductDescend"><button>新品
						↑</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/priceDescend"><button>价格
						↑</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/discountDescend"><button>折扣
						↑</button></a>
			</div>
		</div>
		<div class="rows">
			<div>
				<a href="${pageContext.request.contextPath}/salesAsc"><button>销量
						↓</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/NewProductAsc"><button>新品
						↓</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/priceAsc"><button>价格
						↓</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/discountAsc"><button>折扣
						↓</button></a>
			</div>
			<div>
				<a href="${pageContext.request.contextPath}/findAllshangping"><button>综合
						↑↓</button></a>
			</div>
		</div>

	</div>
	<pg:pager url="${pageContext.request.contextPath}/findAllshangping"
